    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="px-4 py-6 space-y-6">
        <div className="bg-card/80 glass rounded-2xl p-6 border border-border">
          <h2 className="text-xl font-bold text-foreground mb-6">개인정보 처리방침</h2>
          ...
          <div className="space-y-6 text-foreground/80 leading-relaxed">
            ...
            <div>
              <h3 className="text-lg font-semibold text-foreground mb-3">제1조 (개인정보의 처리목적)</h3>
              <p className="mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-foreground mb-3">제2조 (개인정보의 처리 및 보유기간)</h3>
              <p className="mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-foreground mb-3">제3조 (처리하는 개인정보 항목)</h3>
              <p className="mb-4">회사는 다음의 개인정보 항목을 처리하고 있습니다:</p>
              <div className="mb-4">
                <h4 className="font-semibold text-foreground mb-2">필수항목:</h4>
              ...
              <div className="mb-4">
                <h4 className="font-semibold text-foreground mb-2">선택항목:</h4>
                <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-foreground mb-3">제4조 (개인정보의 제3자 제공)</h3>
              <p className="mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-foreground mb-3">제5조 (개인정보의 처리위탁)</h3>
              <p className="mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-foreground mb-3">제6조 (정보주체의 권리·의무 및 행사방법)</h3>
              <p className="mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-foreground mb-3">제7조 (데이터의 상업적 활용)</h3>
              <p className="mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-foreground mb-3">제8조 (개인정보보호책임자)</h3>
              <p className="mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-foreground mb-3">제9조 (개인정보 처리방침 변경)</h3>
              <p className="mb-4">
